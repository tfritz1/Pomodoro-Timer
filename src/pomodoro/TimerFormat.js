...
function TimerFormat ({session, focusDuration, breakDuration}) {
    return (
      session &&
      <div>
        ...
        <div className="row mb-2">
          <div className="col">
            ...
            {session?.label} for {" "}
              {session.label === "Focusing" ? minutesToDuration(focusDuration) : minutesToDuration(breakDuration)} {" "} minutes
            </h2>
