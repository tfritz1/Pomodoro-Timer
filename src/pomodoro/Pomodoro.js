...
function Pomodoro() {
  ...
  return (
    <div className="pomodoro">
      <div className="row">
        <FocusButton focusSubtract = {focusSubtract}
        focusDuration = {focusDuration}
        focusAdd = {focusAdd}
        session = {session}
        />
        <BreakButton breakSubtract = {breakSubtract}
        breakDuration = {breakDuration}
        breakAdd = {breakAdd}
        session = {session}
        />
      </div>
        <TimerController isTimerRunning = {isTimerRunning}
        playPause = {playPause}
        session = {session}
        stop = {stop}
        />
        <TimerFormat session = {session}
        focusDuration = {focusDuration}
        breakDuration = {breakDuration}
        />
    </div>
